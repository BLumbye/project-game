 ...
 */
export const not = (predicate: (element: unknown) => boolean) => (element: unknown) => !predicate(element);
 ...
 */
export const isEmpty = () => (element: unknown) => {
 ...
 */
export const isEqual = (value: unknown) => (element: unknown) => {
 ...
 * @param value The value to match against.
 */
export const isTypeMatch = (value: unknown) => (element: unknown) => {
 ...
 */
export const isLengthEqualTo = (length: number) => (element: string | unknown[]) => {
 ...
 * @param length The length to match.
 */
export const isLengthLessThan = (length: number) => (element: string | unknown[]) => {
  return element.length < length;
};
 ...
 * @param length The length to match.
 */
export const isLengthLessThanOrEqualTo = (length: number) => (element: string | unknown[]) => {
  return element.length <= length;
};
 ...
 * @param length The length to match.
 */
export const isLengthGreaterThan = (length: number) => (element: string | unknown[]) => {
  return element.length > length;
};
 ...
 * @param length The length to match.
 */
export const isLengthGreaterThanOrEqualTo = (length: number) => (element: string | unknown[]) => {
  return element.length >= length;
};
 ...
 */
export const isLengthBetween = (min: number, max: number) => (element: string | unknown[]) => {
 ...
 */
export const isLengthBetweenExclusive = (min: number, max: number) => (element: string | unknown[]) => {
  return element.length > min && element.length < max;
};
 ...
 * @param max The maximum length to match (exclusive).
 */
export const isLengthBetweenInclusiveExclusive = (min: number, max: number) => (element: string | unknown[]) => {
  return element.length >= min && element.length < max;
};
 ...
 * @param max The maximum length to match (inclusive).
 */
export const isLengthBetweenExclusiveInclusive = (min: number, max: number) => (element: string | unknown[]) => {
  return element.length > min && element.length <= max;
};
